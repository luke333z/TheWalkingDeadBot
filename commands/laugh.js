...
module.exports = {
    ...
    execute(message, args){
        ...
        if(random == 0){
            url1 = "https://cdn.discordapp.com/attachments/705049194682908782/754266827198038106/giphy_7.gif";
        }else if(random == 1){
            url1 = "https://cdn.discordapp.com/attachments/705049194682908782/754267506931138570/giphy_8.gif";
        }else if(random == 2){
            url1 = "https://cdn.discordapp.com/attachments/705049194682908782/754267546089291797/giphy_9.gif";
        }else if(random == 3){
            url1 = "https://cdn.discordapp.com/attachments/705049194682908782/754267600359522384/giphy_10.gif";
        }else if(random == 4){
            url1 = "https://cdn.discordapp.com/attachments/705049194682908782/754267641325158491/giphy_11.gif";
        }else if(random == 5){
            ...
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765597937401069628/mishoun_smile.gif";
        }
