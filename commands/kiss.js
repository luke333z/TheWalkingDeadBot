...
module.exports = {
    ...
    execute(message, args){
        ...
        if(random == 0){
            ...
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765596765419470918/aaron_und_eric.gif";
        }else if(random == 5){
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765596768687357993/gless_margret_kissus.gif";
        }else if(random == 6){
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765596783538995221/sahsah_bob_kis.gif";
        }
