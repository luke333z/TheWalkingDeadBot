...
module.exports = {
    ...
    execute(message, args){
        ...
        if(random == 0){
            ...
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765594036517863485/coralricc_hughhughu.gif";
        }else if(random == 6){
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765594048361660476/ty_and_sasha.gif";
        }else if(random == 7){
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765594061246693416/ricc_carul_hug.gif";
        }else if(random == 8){
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765594072559517706/sahsa_ty.gif";
        }else if(random == 9){
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765594084055449650/this_guy_and_beth_hugg.gif";
        }else if(random == 10){
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765594106192724018/darul_karul_hug.gif";
        }else if(random == 11){
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765594118289621053/megi_mishoun_huggug.gif";
        }else if(random == 12){
            url1 = "https://cdn.discordapp.com/attachments/753567636968833103/765594126808514600/glenus_megus_hugus.gif";
        }
